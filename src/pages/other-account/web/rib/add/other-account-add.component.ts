...
export class OtherAccountAdd extends OtherAccountAddEdit implements OnInit, OnDestroy {
        ...
        this.otherAccountService.masterData().then((objResponse: any) => {
            ...
            if (result.responseStatus.responseCode == this.constants.RESP_CODE_SUCCESS) {
                ...
                let confirmAddExtAccountData = {
                    ...
                    anyIDTypeLabel: this.currentLang.toUpperCase() == this.constants.CULTURE_SHORTNAME_ENGLISH ? data.labelEn : data.labelTh,
                    anyIDTypeDesc: this.currentLang.toUpperCase() == this.constants.CULTURE_SHORTNAME_ENGLISH ? data.descriptionEN : data.descriptionTH,
                };
