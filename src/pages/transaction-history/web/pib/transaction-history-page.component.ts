...
export class TransactionHistoryPageComponent extends TransactionHistoryPage implements OnInit {
    constructor(
        ...
        super(myAccountService, constants, fundTransferService, billPaymentService, translateService, utilService, dateservice, reportService, masterDataService, _PermissionService);
    } 
    ngOnInit() {
        this.webStyle = this.constants.STYLE_PIB_WEB;
        this.alertConfig = {
            title: '',
            type: 'danger',
            message: '',
