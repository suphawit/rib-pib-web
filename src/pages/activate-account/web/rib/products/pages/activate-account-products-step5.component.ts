...
@Component({
    selector: 'activate-account-products-step5',
    templateUrl: 'activate-account-products-step5.html'
})
export class ActivateAccountByProductsStep5Component implements OnInit {
    stepCaptionData: any;
    ...
    constructor(public activateAccountService: ActivateAccountService){
        activateAccountService.validPage('products5');
    }
    ...
    requestActivateAccount(data: any){
        data.subscriptionChannel = 'PRODUCT';
