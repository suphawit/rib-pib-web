...
export class PIBBillPaymentStep1 extends BillPaymentStep1 implements OnInit, OnDestroy {
  ...
  constructor(public constants: Constants,
    ...
    super(constants, cdRef, fundTransferService, myAccountService, permissionChangeRoute, billPaymentService, otherAccountService, bankCodeDataService, utilService,translateService,permissionService,billPaymentRequestToPayService);

  }

  ngOnInit(): void {
    this.settings = { module: 'BILLPAYMENT', styleClass: this.constants.STYLE_PIB_WEB };
    this.init();
