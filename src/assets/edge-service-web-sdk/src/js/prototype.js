...
var KKPESClass = (function() {
    ...
    function create() {
        ...
        Object.extend(klass, KKPESClass.Methods);
...
var PeriodicalExecuter = KKPESClass.create({
...
var Template = KKPESClass.create({
...
var Enumerable = (function() {
    ...
    function zip() {
        ...
        var collections = [this].concat(args).map(toArray);
        return this.map(function(value, index) {
...
var ObjectRange = KKPESClass.create(
    Enumerable,
    (function() {
...
Ajax.Request = KKPESClass.create(Ajax.Base, {
    _complete: false,
...
Ajax.Response = KKPESClass.create({
...
Ajax.Updater = KKPESClass.create(Ajax.Request, {
...
Ajax.PeriodicalUpdater = KKPESClass.create(Ajax.Base, {
    initialize: function($super, container, url, options) {
        $super(options);
