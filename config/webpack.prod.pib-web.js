...
function getPlugins() {
  ...
  return [
    ...
    new CommonsChunkPlugin({
      ...
      //name: ['main', 'vendor', 'ibmmfpfanalytics', 'ibmmfpf', 'polyfills']
    }),
   ...
   */
    ...
    new HtmlWebpackPlugin({
      template: 'src/index_prod_pib_web.html',
      title: "PIB",
...
module.exports = function (env) {
  ...
  return {
    entry: {
      ...
      'main': './src/app/web/pib/pib-web.main.dev.ts'
        ...
        */
        {
          test: /\.html$/,
          loader: 'raw-loader',
          exclude: [helpers.root('src/index_prod_pib_web.html')]
        },
